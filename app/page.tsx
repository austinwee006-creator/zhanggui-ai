...
const QUICK_ACTIONS = [
  {
    label: "菜单建议",
    desc: "提升客单价与吸引力",
    prompt: "帮我分析现有菜单，给出提升客单价和吸引力的具体建议。",
    icon: <ClipboardIcon />,
  },
  {
    label: "营销文案",
    desc: "社媒推广与宴会预订",
    prompt: "帮我写一篇适合发布在社交媒体的餐厅推广文案，要吸引客人预订宴会。",
    icon: <MegaphoneIcon />,
  },
  {
    label: "客诉处理",
    desc: "有效回应与服务补救",
    prompt: "客人投诉菜品口味和上菜速度，应该如何处理和回覆？",
    icon: <ChatIcon />,
  },
  {
    label: "成本分析",
    desc: "食材成本控制与优化",
    prompt: "如何分析和控制餐厅的食材成本？给出具体的执行步骤。",
    icon: <ChartIcon />,
  },
];
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <p className="text-xs text-stone-400">餐厅老板的 AI 助手</p>
            </div>
          </div>
        </div>
        {messages.length > 0 && (
